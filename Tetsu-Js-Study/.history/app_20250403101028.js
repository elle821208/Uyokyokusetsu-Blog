...
// for文  for(初期値;条件式;増減式インクレメント;) {処理}  1:04:00～
const questions = [
...
console.log(pikachu.skills[] + "←オブジェクトpikachu2の配列skillsの0番目");
...
//
for (let index = 18; index < this.level.length; index++) {
