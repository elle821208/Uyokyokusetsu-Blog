...
function getSeason(month) {
    // 作業の流れ:
    //  (1) new Date() で日時オブジェクトを作成
    //  (2) .getMonth() で「月（0～11）」を厳選
    //  (3) +1 して 1～12 の形式に直し、引数 month に渡され if 文で処理される
...
// 2. メソッドで値を厳選（.getHours(), .getMonth()）
// 3. 変数や if 文で作業（判定・代入・出力）
