...
function skeletonFunction(num, actionFunction) { 
    ...
    // つまり skeletonFunction 内で書かれている actionFunction(num) は、
    // actionFunction = judgeFunction, num = 10 なので
    // → judgeFunction(10) という形に置き換わり、実際に呼び出される。
    ...
    // function skeletonFunction(num, actionFunction) { 
    // ↓ 呼び出し側で skeletonFunction(10, judgeFunction)によって
    // function skeletonFunction(10, judgeFunction) { 
    // ↓
    // 骨組み関数内の actionFunction(num);
    // ↓
