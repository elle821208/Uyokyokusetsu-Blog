...
// =======================================
// データ型（typeof）の例
//    （JavaScriptで値の種類を確認する方法）
// =======================================

// typeof → 値の「データ型（種類）」を調べるキーワード
// 文字列（string）、数値（number）、論理値（boolean）、nullなどがある
...
// 「→」はただの記号（右向き矢印）。見やすく区切るために出力しているだけ。
// 「+」は文字列どうしをつなげる（連結する）演算子。
console.log('"ラスカル" → ' + "ラスカル");
...
// "null"（文字列としての null）
// --------------------------------------------------
console.log("=== 文字列としての 'null' ===");
console.log('"null" → ' + "null");
console.log("👉 上の行では null が文字列としてそのまま表示される");

console.log('"null" の typeof → ' + typeof "null");
console.log("👉 上の行では string が表示される（文字列として扱われる、本当の null ではない）");


// ===================================
// ポイントまとめ
// ===================================
// 1. 「→」はただの記号。出力を見やすくするために使っているだけ
// 2. 「+」は文字列どうしをつなげる（連結する）演算子
// 3. typeof なし → 値そのものが表示される
// 4. typeof あり → 値のデータ型（種類）が表示される
// 5. 文字列 → string、数値 → number、真偽値 → boolean
// 6. "null"（文字列のnull）は string になる。本当の null とは違う
