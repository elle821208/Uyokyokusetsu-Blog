...
//    !   → 「逆さまにする」
//           true を false に、false を true にする
//    &&  → 「どっちもOK＝true？」
//           左も右も ok = true なら「はい！」（true）
//           どちらかでも false なら「ダメ！」（false）
//    ||  → 「どっちかOK＝true？」
//           左か右のどちらか1つでも ok = true なら「はい！」（true）
//           両方ダメ（false）なら「ダメ！」（false）

// ---------- &&（どっちもOK＝true？）の例 ----------
let hasTicket = true;   // チケットを持っている？
let isAdult = false;    // 大人かな？
...
// |-----------|---------|-------|----------------|
// | true      | true    | true  | if の中        |
// | true      | false   | false | else の中      |
// | false     | true    | false | else の中      |
// | false     | false   | false | else の中      |

// (2) ||（どっちかOK＝true？）
// | ateMeal | ateSnack | 結果  | 出るメッセージ |
// |---------|----------|-------|----------------|
// | true    | true     | true  | if の中        |
// | true    | false    | true  | if の中        |
// | false   | true     | true  | if の中        |
// | false   | false    | false | else の中      |

// 【まとめ】
// ・&& → 両方とも ok = true なら true
// ・|| → どちらか1つでも ok = true なら true
// ・! → 逆さまにする（true ⇄ false）
