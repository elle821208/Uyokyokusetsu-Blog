...
// https://youtu.be/ZE484EEuQ8k?si=qE-_dh3BZNDctbmq
// <!--1:51:15～-->
//Q."サンダー"、"ホウオウ"、"スイクン"、"ラティアス"、"パルキア"を持つ配列const myCreatures = ["ライオネル", "フェニクス", "ミズノカミ", "ソライア", "クロノス"];
を作成しなさい。
...
console.log(myCreatures); // ["ライオネル", "フェニクス", "ミズノカミ", "ソライア", "クロノス", "ルーシオン"]

// ==========================================
// Q. myCreatures に今いくつの仲間がいるか出力しなさい。
// ==========================================
// 配列の「.length」を使うと、要素の数（仲間の人数）を知ることができます。
console.log(myCreatures.length); // 6（＝6体の空想生物がいる）
...
// まとめた結果を表示
console.log(allGenerations + " ← concatで配列 oldGenerations と newGenerations をくっつけた");
