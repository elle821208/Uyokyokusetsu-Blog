...
function skeletonFunction(num, actionFunction) { 
    ...
    // 骨組み関数 function skeletonFunction(num, actionFunction) { 
    // ↓ 呼び出し側の skeletonFunction(10, judgeFunction) の引数によって
    // 骨組み関数 function skeletonFunction(10, judgeFunction) { 
    // ↓
    // 骨組み関数内の コールバック引数 actionFunction(num); は
    // ↓ 呼び出し側の引数より 第一引数 num = 10 、第二引数 actionFunction = judgeFunction のため
