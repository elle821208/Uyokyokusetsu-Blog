...
/// ↓↓↓ index.htmlのid="shingeki"を取得して文字を追加する操作をする。
document.querySelector("#shingeki").innerText = "一匹残らず駆逐してやる！（←jsのdocument.querySelector(#shingeki).innerText で htmlのid=shingekiのところにテキストを追加。）";
