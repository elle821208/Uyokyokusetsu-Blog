...
console.log("↓↓↓ const resultValue = hyperDrive(); "
    + "下記のonst resultValueでは 関数名 hyperDrive の後ろに () をつけると関数hyperDrive実行され、戻り値が resultValue に入る。");
const resultValue = hyperDrive(); 
// 上記のresultValueでは 関数名 hyperDrive の後ろに () をつけると関数hyperDrive実行され、戻り値が resultValue に入る
