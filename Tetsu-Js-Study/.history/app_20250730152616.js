...
console.log("呼び出し元console。↑上の行で関数メソッドlevelUpを一回実行している。関数メソッドlevelUpにthis.level++;インクレメントとif文。オブジェクトPikachu2のレベル20 レベル20でスキルにスパークが追加される。→:", pikachu2.level, pikachu2.skills);
