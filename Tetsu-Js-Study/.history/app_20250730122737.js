...
console.log("呼び出し元。snsUser2.post(引数：プログラミングなう。) で 上記のsnsUserオブジェクトのpost関数をreturnで呼び出す。returnのところでthis.userNameでオブジェクトsnsUser2のuserNameプロパティTomoko →" + snsUser2.post("プログラミングなう。"));
