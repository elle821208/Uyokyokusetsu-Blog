...
console.log(snsUser2.post("プログラミングなう。"));//(1)呼び出し元。オブジェクトsnsUser2のメソッドpostを実行し呼び出す。
...
const pikachu2 = {
    ...
    levelUp: function () {//メソッドlevelUp
        
    },
    
};
console.log(pikachu2.levelUp);//呼び出し元。オブジェクトpikachu2のlevelUpメソッドを実行する。
