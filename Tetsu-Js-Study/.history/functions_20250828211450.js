...
function getSeason(month) {
    ...
    console.log("👉 今回は new Date().getMonth() + 1 の結果（現在の月 1～12）を受け取っている");
    console.log("   例えば、5月なら new Date().getMonth() は 4 を返す → +1 して 5 が month に入る");
    console.log("   例えば、12月なら new Date().getMonth() は 11 を返す → +1 して 12 が month に入る");
