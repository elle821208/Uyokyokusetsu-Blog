...
var lists = ["佐藤", "伊藤", "鈴木", "木村", "田中", "高橋"];//配列
for (var i = 0; i < lists.length; i++) {//初期値iで最初の配列の数は0、条件式iが配列listsの配列の数より小さい時、増減式i++で配列の数iが1ずつ増ええていく
  console.log(lists[i]); //iの値は配列の数を越すまでは増えていく。
}
...
for (let index = 0; index < questions.length; index++) {//初期値iで最初の配列の数は0、条件式iが配列indexの配列の数より小さい時、増減式i++で配列の数iが1ずつ増ええていく
