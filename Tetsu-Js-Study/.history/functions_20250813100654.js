...
// --------------------------------------------------
console.log("↓↓↓ const resultValue = hyperDrive(); で 定数 resultValue を定義し、"
    + "関数 hyperDrive を実行する。関数名 hyperDrive の後ろに () をつけると、"
...
console.log(`${resultValue} ← この波括弧 resultValue は、
    定数 resultValue を参照（変数に入っている値をそのまま使う）している。
    つまり、定数 resultValue に格納されたアロー関数 hyperDrive の戻り値 7777 を表示している。`);
