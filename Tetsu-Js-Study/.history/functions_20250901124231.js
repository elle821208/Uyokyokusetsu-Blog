...
function a(b) {
    ...
    console.log("3️ Hi,Cat!"); // メイン処理
    b(); // 4️⃣ コールバック呼び出し（b() = c()）
    console.log("4️⃣-2️⃣ 追加処理：メイン関数内でも少し動作できる");
}
...
function c() {
    ...
    console.log("5️⃣-2️⃣ Hi,Dog! さらに追加の処理を差し替え可能！");
}
...
// 5️⃣ "Hi,Bat!" が出力（追加処理）
//       ↓
// 5️⃣-2️⃣ "Hi,Dog!" が出力（追加処理差し替え可能）
//       ↓
// 4️⃣-2️⃣ メイン関数内の追加処理も実行
//       ↓
// 完了！
