...
///<!--2:04:30～-->
const $zoozoo = document.querySelectorAll(".barbar");//変数にquerySelectorAll(".barbar")4つの.barbarクラスを格納しておく。

$zoozoo[3].innerHTML = "<div>変数$zoozoo（）に格納した後、この変数をinnerHTMLで編集する。これは[4]番目。</div > ";