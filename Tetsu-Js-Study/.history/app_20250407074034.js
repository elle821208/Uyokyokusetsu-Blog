...
console.log(document.querySelector("#foofoo").innerHTML = "<div>1つのidをひとつの変数として取得した。htmlにおいてidは1ページに一つしか存在できない。</div>");//idは#をつける。一つの変数としてカウントされる。htmlにおいてidは1ページに一つしか存在できない。
