...
console.log(hornDrill(100));//関数hornDrillの引数theirHpの値は仮で100とする。




// <!--1:37:00～-->
//オブジェクト（データをまとめて管理する箱のゆおうなもの）
const snsUser = {//const オブジェクト名
    id: 1,//プロパティ名: 値
    userName: "Taro",
    gender: "male",
    like: function () {
...
console.log(snsUser.id);//オブジェクト名.プロパティ名で値を取り出す。
