...
//グローバル変数<!--1:29:00～-->
const barbar ="関数jooのスコープ外";//変数barbarを定義する。値は5。※ここはスコープ（関数jooの中）の外側。

function joo() {//関数joo
    const barbar ="関数jooのスコープ内";//スコープ内（関数jooの中）で変数barbarを定義している。
    console.log(barbar);//で変数barbarを呼び出す。"関数jooのスコープ内"が表示される。
}

console.log(barbar);//スコープ外。変数bar5を呼び出す。"関数jooのスコープ外"が表示される※ここは関数jooの外側。
