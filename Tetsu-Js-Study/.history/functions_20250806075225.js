...
function greetWithCallback(callbackAction) {
  ...
  console.log(" main処理 → Hell,hello,Tom!");
...
function sayGuestName() {
  ...
  console.log("add処理（その１） → Hell,hello,Ken!");
  // (6) ← 「Hi,Ken!」と表示して終了
}

// ▼ 追加関数②：ゲストの年齢を紹介
function sayGuestAge() {
  console.log("add処理（その２） → I'm,mmmmm 25 years old!");
}
