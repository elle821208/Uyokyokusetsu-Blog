...
//↓↓↓ DOM用（HTMLのクラス用）の情報（タグの種類、クラス、クラス名、文章"おなか減ったなう"）を入れる
    ...
    $post.setAttribute("class", "post");//上記の変数$post"articleタグ"にDOM用の"クラス"（第一引数）を付与し、"post"（第二引数）というクラス名をつける。
...
const $pikachu22 = document.createElement("article");///DOM操作。クラス用の情報（$pikachu22）を作る。
$pikachu22.setAttribute("class","")
