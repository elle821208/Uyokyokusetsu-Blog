...
// 【例2】計算する関数 コールバック関数doubleFunction
function コールバック関数_doubleFunction(コールバック引数_n) {
    // コールバック引数_n = 数字（ここでは skeletonFunction から渡される値、例: 5）

    // 【説明】
    // コールバック関数_doubleFunction は skeletonFunction に渡される「コールバック関数」の一例
    ...
    // - コールバック引数_n = 5 がコールバック関数_doubleFunction に渡される
