...
console.log(
  "呼び出し元 console。" +
  "↑上の行でオブジェクト pikachu2 の関数メソッド levelUp を 1 回実行。" +
  "levelUp 内では this.level++（インクレメント） によってレベルが 1 上がり、" +
  "if 文でレベルが 20 以上になったかを判定。" +
  "条件を満たしたため、新しいスキル『スパーク』が skills 配列に追加された。" +
  "現在のレベルとスキル一覧 →",
  pikachu2.level,
  pikachu2.skills
);
