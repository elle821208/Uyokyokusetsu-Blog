...
console.log("1st Pikachu:", pikachu2.level, pikachu2.skills);//1stでlevel18を表示する。
pikachu2.levelUp();//reオブジェクトpikachu2のメソッドlevelUpを実行する。
console.log("2nd Pikachu:", pikachu2.level, pikachu2.skills);//2ndでlevel19を表示する。
pikachu2.levelUp();//オブジェクトpikachu2のメソッドlevelUpを実行する。
console.log("3rd Pikachu:", pikachu2.level, pikachu2.skills);//3rdでlevel20を表示する。
