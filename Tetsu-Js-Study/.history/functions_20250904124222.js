...
console.log("↓↓↓ コールバック版（差し替え可能処理）の比較 ↓↓↓");
...
skeletonFunction(3, judgeFunction);         // コールバック版（骨組み関数 skeletonFunction + コールバック関数 judgeFunction）

console.log("=== 入力値 5 の場合 ===");
fixedJudgeFunction(5);                      // if文版（固定処理関数 fixedJudgeFunction）
skeletonFunction(5, doubleFunction);        // コールバック版（骨組み関数 skeletonFunction + コールバック関数 doubleFunction）
