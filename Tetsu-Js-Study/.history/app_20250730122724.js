...
console.log("呼び出し元。snsUser2.post(引数：プログラミングなう。)でsnsUserオブジェクトのpost関数をreturnで呼び出す。returnのところでthis.userNameでオブジェクトsnsUser2のuserNameプロパティTomoko →" + snsUser2.post("プログラミングなう。"));
