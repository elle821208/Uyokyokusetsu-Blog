...
console.log("呼び出し元console。オブジェクトPikachu2の初期のレベル18 レベル128スキル。→:", pikachu2.level, pikachu2.skills);
...
console.log("呼び出し元console。↑の行で関数メソッドlevelUpを一回実行している。オブジェクトPikachu2のレベル19→:", pikachu2.level, pikachu2.skills);
