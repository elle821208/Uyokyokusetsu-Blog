...
<main>
    ...
    <section id="information">
        ...
        <div class="articles_container"><!--サブループその１＆その２（技術ブログ用）-->
            ...
            ?>
            <h2>技術ブログ</h2>
            <h1>↓サブループその１</h1><!--サブループその１（メインループ「技術ブログ（techカテゴリー）」の投稿を5件だけ取得し、繰り返し表示するためのサブループ） -->
            ...
            <!--「functions.php」で登録した新規の投稿一覧。カスタム投稿タイプ works を、「index.php」でサブループを使って表示するためのコード-->
