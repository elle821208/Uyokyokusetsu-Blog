...
<!--2025-05-23 chatgptより-->
                <?php
$main_args = array(
    'post_type' => 'post',
    'posts_per_page' => 6,
    'category__not_in' => array(get_cat_ID('tech'))
);
...
?>
    ...
    <!--↑↑↑2025-05-23 chatgptより-->
            ...
            </div><!--メインループarticlesタグの閉じタグ。ループ文でarticleタグ（wpの投稿）を回す-->
...
<!-- 2025_05-23 Techカテゴリ専用サブループ -->
<div class="tech-articles_container">
    <h2>Tech記事一覧</h2>
    <div class="tech-articles">
        ...
        ?>
            <article>
                ...
                <h2><?php the_title(); ?></h2>
                <a href="<?php the_permalink(); ?>">Tech記事詳細はこちら</a>
            </article>
