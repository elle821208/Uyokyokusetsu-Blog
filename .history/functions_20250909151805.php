...
function my_enqueue_scripts() {
    // ✅ 学習用JSを読み込む
    wp_enqueue_script(
        'tetsu-js-study',  // 識別名（自由にOK）
        get_template_directory_uri() . '/Tetsu-Js-Study/Tetsu-Js-Study.js', // ファイルの場所
        array(),  // 依存関係（jQueryに依存するなら ['jquery'] と書く）
        '1.0',    // バージョン（更新時キャッシュ回避に使える）
        true      // trueなら</body>直前に読み込む
    );
}
