...
// バッククォート（`...`） ← テンプレートリテラル (String.rawで\nで文字のまま出量くされる)
const a4 =String.raw`テンプレート\nリテラル`;
console.log(a4);
...
const sentence1 = '名前は' + name + 'です。年齢は' + age + '歳または' + (age + 1) + '歳で、' + address + 'に住んでいます' + '名前はのび太です。年齢は10歳または11歳で、東京都に住んでいます
';
console.log(sentence1);

// テンプレートリテラルを使う方法
const sentence2 = `名前は${name}です。年齢は${age}歳または${age +1}歳で、${address}に住んでいます`;
