...
<<<<<<< HEAD
    <section id="information">
        ...
        ////↓↓↓WP_Queryがサブループ「works（実績）」
        ////※↓↓↓ メインループwhile (have_posts()): the_post(); とは別のループ<?php while ($the_query->have_posts()) : $the_query->the_post();を使う。
        //クエリの作成と発行をし、取得したデータを「$the_query」に格納
