...
// 作業の流れ:
// (0) currentMonth の値は、上記 2. で取得した「現在の月（new Date().getMonth() + 1）」から来ている
// (1) currentMonth の値（今回の設定の2025年8月28日より 8）が
//     getSeason の括弧の中の month に入る
// (2) 関数内で if 文によって季節が判定される
// (3) 判定結果（今回の設定の2025年8月28日より 夏）が戻り値となり
//     const season に代入される
