...
console.log(`$波括弧resultValue 定数 resultValue を呼び出す。定数 resultValue の中に格納された アロー関数 hyperDrive の戻り値 7777 を参照する。→ ${resultValue}`);


// --------------------------------------------------
// 関数名そのものを直接呼び出す例
// --------------------------------------------------
console.log(`$波括弧hyperDriveカッコ で 関数 hyperDrive() を直接呼び出した。 → ${hyperDrive()}`);
