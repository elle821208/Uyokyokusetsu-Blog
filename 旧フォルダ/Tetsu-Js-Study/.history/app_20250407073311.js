...
///<!--2:04:30～-->
const $zoozoo = document.querySelectorAll(".barbar");//変数にquerySelectorAll(".barbar")を格納しておく。

$zoozoo[3].innerHTML = "<div>変数$zoozooにquerySelectorAll(".barbar")格納した後、この変数をinnerHTMLで編集する。これは[4]番目。</div > ";