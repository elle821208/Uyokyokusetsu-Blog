...
console.log("1st Pikachu2:", pikachu2.level, pikachu2.skills);//1stでlevel18のlevelと配列skillsを表示する。
pikachu2.levelUp();//オブジェクトpikachu2のメソッドlevelUpを実行する。
console.log("2nd Pikachu2:", pikachu2.level, pikachu2.skills);//2ndでlevel19を表示する。
pikachu2.levelUp();//オブジェクトpikachu2のメソッドlevelUpを実行する。
