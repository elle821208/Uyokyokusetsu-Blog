...
console.log("↓↓↓ const resultValue = hyperDrive(); "
    + "で定数 resultValue の中に 戻り値7777を持った アロー関数 hyperDrive を格納する。");
const resultValue = hyperDrive(); 
// 上記のconst関数名 hyperDrive の後ろに () をつけると関数hyperDrive実行され、戻り値が resultValue に入る
// ここで resultValue に入っているのは関数でなく「数値 7777」であり resultValue は「参照」しかできず、関数のように呼び出すことはできない
