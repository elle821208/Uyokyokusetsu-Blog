...
constr number = 1; // (1-1) グローバル変数 number を作り、「1」を入れる。
...
function showNumber() {
  ...
  console.log("ローカル変数（関数ShowNumberの中）関数number の値である2が表示される → " + number); 
  // (2-3) 結果：2 が表示される（※関数を実行したときに表示される）。
...
// (4) グローバル変数の値を表示
// =======================================
console.log("グローバル変数（関数ShowNumberの外）関数number の値である1が表示される → " + number); 
// (4-1) 結果：1 が表示される。
