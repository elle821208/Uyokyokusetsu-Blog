...
function getSeason(month) {
    ...
    console.log("👉 具体例:");
    console.log("   - もし現在が 4月なら → new Date().getMonth() は 3 を返す → +1 して 4 → currentMonth に 4 が入る → その 4 が month に渡る");
    console.log("   - もし現在が 12月なら → new Date().getMonth() は 11 を返す → +1 して 12 → currentMonth に 12 が入る → その 12 が month に渡る");
    console.log("👉 このように、currentMonth が『出発点』となり、それがそのまま month に代入される仕組みになっている");
