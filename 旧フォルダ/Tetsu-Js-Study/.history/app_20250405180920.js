...
///<!--2:02:19～-->
//querySelector
console.log(); document.querySelector("#foo777")//idは#をつける
console.log();document.querySelectorAll(".bar888")//classは.をつける

console.log();document.getElementById("foo777")//id
document.getElementsByClassName("bar")//class
