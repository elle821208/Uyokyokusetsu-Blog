...
if (!isUserLoggedIn) { // isUserLoggedIn が false のとき実行
  console.log(" ログインできていません ");
  console.log(" ← 変数 isUserLoggedIn の値が true ではないため、この if 文が実行されました。");
} else { // それ以外（true）のとき実行
  console.log("✅ ログイン済みです！ようこそ 🎉");
  console.log(" ← 変数 isUserLoggedIn の値が true なので else 文が実行されました。");
