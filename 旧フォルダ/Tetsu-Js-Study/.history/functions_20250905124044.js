...
// ======= セクション開始：変数を渡すパターン =======
console.log("🚩【セクション1】コールバック関数の代わりに『数字』を渡す例");
console.log("    f = 骨組み関数, g = 引数, i = 数字");

// =======================================
// 🚩STEP2: 骨組み関数定義 f（呼び出される側）
// =======================================
function f(g) {
    console.log("[STEP1] メイン処理：必ず実行される基本の動作（骨組み部分）");

    console.log("[STEP2] 骨組み関数の追加処理：毎回必ず実行される");

    console.log("[STEP3] 今回はコールバック関数が無いので、値をそのまま表示するよ！");
...
// =======================================
let i = 42; // ただの数字（変数）
console.log("=== 呼び出し開始（f に数字を渡す） ===");
f(i);
console.log("=== セクション1終了 ===\n\n");

// =======================================
// 🚩 処理の流れまとめ（矢印付き・骨組み関数版）
// =======================================
console.log("🚩【処理の流れまとめ（矢印付き・数字を渡す版）】");
console.log("呼び出し: f(i)  🚩STEP1");
console.log("       ↓");
console.log("g = i   ← f(i) = f(g) なので g は i の値 42 を指す  🚩STEP2");
console.log("       ↓");
console.log("【1️⃣】メイン処理 f が実行（固定の骨組み部分）");
console.log("       ↓");
console.log("関数は渡されていないので b() のような呼び出しはなく、単に g の値を表示");
console.log("👉 実際に表示される値 g =", i, "🚩STEP3");
console.log("       ↓");
console.log("【2️⃣】骨組み関数 f の追加処理（固定で必ず実行される）");
console.log("       ↓");
console.log("完了！ 🎉");
