...
///<!--2:08:03～-->
    ...
    const $timeline = document.querySelectorAll(".timeline")[0];//変数timelineを宣言する。querySelectorAllでHTMLに作っておいた.timelineクラスの引数に設定しておく。
    $timeline.appendChild($post);//timelineに引数に入れたHTMLタグに