...
//グローバル変数<!--1:29:00～-->
const bar5 = 5;//変数bar5を定義する。値は5。※ここは関数jooの外側。
const bar6 = 6;//変数bar5を定義する。値は5。※ここは関数jooの外側。

function joo() {//関数joo
    const bar6 = 6;//関数jooの中で変数bar6を定義している。
    console.log(bar6);//変数jooの中で変数bar6を呼び出す。
}
joo();

console.log(bar5);//変数bar5を呼び出す。※ここは関数jooの外側。
console.log(bar6);//変数bar5を呼び出す。※ここは関数jooの外側。
