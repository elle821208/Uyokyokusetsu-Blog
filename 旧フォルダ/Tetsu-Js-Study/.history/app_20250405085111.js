...
console.log("1st Pikachu2:", pikachu2.level, pikachu2.skills);//1stで18。levelと配列skillsを表示する。
pikachu2.levelUp();//オブジェクトpikachu2のメソッドlevelUpを実行する。
console.log("2nd Pikachu2:", pikachu2.level, pikachu2.skills);//2ndで19。levelと配列skillsを表示する。
pikachu2.levelUp();//オブジェクトpikachu2のメソッドlevelUpを実行する。
console.log("3rd Pikachu2:", pikachu2.level, pikachu2.skills);//3rdで20。levelと配列skillsを表示する。
console.log( pikachu2.level, pikachu2.skills);//3rdで20。levelと配列skillsを表示する。
