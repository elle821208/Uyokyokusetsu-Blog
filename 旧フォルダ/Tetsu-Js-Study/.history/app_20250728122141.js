...
function getSeason() {
    ...
    const month = new Date().getMonth() + 1;//const変数monthを定義。中身は上記の通り。
...
const season = getSeason();//constで変数seasonを定義。中身は関数getSeason。
...
console.log("上記で定義した関数getSeasonを変数seasonで使う→"+season);
