...
///<!--2:02:19～-->
//querySelector
console.log(" ↓ querySelectorで一つの#foofoo(id)を一つの変数として取得した。htmlにおいてidは1ページに一つしか存在できない。");
console.log(document.querySelector("#foofoo"));//idは#をつける。一つの変数としてカウントされる。htmlにおいてidは1ページに一つしか存在できない。
console.log(" ↓ querySelectorAllで複数ある.barbarクラスを配列としてまとめて取得した。htmlにおいてclassは1ページに複数存在できる。");
console.log(document.querySelectorAll(".barbar"));//classは.をつける。classを全て取得する。配列になる。
...
console.log(document.getElementById("foofoo") +"id");//id。一つの変数としてカウントされる。
