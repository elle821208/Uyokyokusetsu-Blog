...
const $timeline = document.querySelectorAll(".timeline")[0]; //querySelectorAllでHTMLに記述した.timeline(引数)クラス※ドット忘れずにの[]番目を取得する。
...
//HTMLで作ったクリックイベント用のボタン（id=button22）を取得しイベントを付与する。イベント内容はクリックしたらHTMLに記載された$outputにDOM操作で$pikachu22組み込まれ、"ピカチュウ！"が表示される
