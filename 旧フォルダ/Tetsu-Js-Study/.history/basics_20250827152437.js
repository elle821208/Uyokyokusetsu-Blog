...
// グローバル変数を定義
let Number = 1;
console.log(`グローバル変数 Number = ${Number} （今回の値は 1）を設定しました。`);
...
function showNumber() {
    ...
    console.log(`【関数内】ローカル変数 Number = ${Number}`);
    console.log("function showNumber は『定義しただけ』の状態です。"
        + " ローカル変数 Number は関数 showNumber を『呼び出したとき』にだけ表示されます。");
}
...
console.log(`グローバル変数 Number = ${Number} （今回の値は 1）`);

console.log("⚠️ 関数内のローカル変数 Number は外からは見えません（使えません）");
console.log("👉 外から 2 を直接表示することはできません。");
console.log("👉 関数を呼び出したときだけ、ローカル変数 Number = 2 が表示されます。");
